 ...
 * unused code.", 2022-07-20), which dropped _CLOCK_THREAD_CPUTIME_ID and its
 ...
 * _start with "Unresolved global GOT.mem._CLOCK_THREAD_CPUTIME_ID / Missing
 ...
 *
 * This is NOT a fabricated clock: __WASI_CLOCKID_THREAD_CPUTIME_ID == 3 is
