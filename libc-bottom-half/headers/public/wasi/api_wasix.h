...
/**
*** Hidden type
typedef uint64_t __wasi_size_t;
...
_Static_assert(sizeof(__wasi_addr_unix_cidr_t) == 1, "witx calculated size");
_Static_assert(_Alignof(__wasi_addr_unix_cidr_t) == 1, "witx calculated align");
_Static_assert(offsetof(__wasi_addr_unix_cidr_t, unused) == 0, "witx calculated offset");
...
_Static_assert(offsetof(__wasi_epoll_data_t, fd) == 8, "witx calculated offset");
_Static_assert(offsetof(__wasi_epoll_data_t, data1) == 12, "witx calculated offset");
...
_Static_assert(sizeof(__wasi_proc_spawn_fd_op_t) == 64, "witx calculated size");
...
_Static_assert(offsetof(__wasi_proc_spawn_fd_op_t, path) == 16, "witx calculated offset");
_Static_assert(offsetof(__wasi_proc_spawn_fd_op_t, path_len) == 24, "witx calculated offset");
_Static_assert(offsetof(__wasi_proc_spawn_fd_op_t, dirflags) == 32, "witx calculated offset");
_Static_assert(offsetof(__wasi_proc_spawn_fd_op_t, oflags) == 36, "witx calculated offset");
_Static_assert(offsetof(__wasi_proc_spawn_fd_op_t, fs_rights_base) == 40, "witx calculated offset");
_Static_assert(offsetof(__wasi_proc_spawn_fd_op_t, fs_rights_inheriting) == 48, "witx calculated offset");
_Static_assert(offsetof(__wasi_proc_spawn_fd_op_t, fdflags) == 56, "witx calculated offset");
_Static_assert(offsetof(__wasi_proc_spawn_fd_op_t, fdflagsext) == 58, "witx calculated offset");
...
_Static_assert(sizeof(__wasi_function_pointer_t) == 8, "witx calculated size");
_Static_assert(_Alignof(__wasi_function_pointer_t) == 8, "witx calculated align");
...
/**
 * Forks only the environment of the current process into a new subprocess,
 * without modifying the control flow. The semantics match up with the
 * traditional `vfork` system call. It is important to note that this
 * will not setup anything related to control flow - the new process
 * will continue in the same memory and call stack as the parent process.
...
/* Firebox WASIX extension prototypes + constants (firebox#796). */
